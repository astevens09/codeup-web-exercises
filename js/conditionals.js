 ...
 */
 ...
 //   if(color=="blue"){
 //     return "The ocean is blue as well.";
 //   }else if(color=="red"){
 //     return "Red is the best color for a Ferarri!";
 //   }else if(color == "yellow"){
 //     return "Sunflowers have yellow."
 //   }else if(color == 'orange'){
 //     return "Just like an orange fruit."
 //   }else if(color == 'black'){
 //     return "Santa brings coal that is black too."
 //   }else if(color=='green'){
 //     return "Yellow and blue make green."
 //   }else{
